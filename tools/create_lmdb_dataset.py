...
def createDataset(data_list, outputPath, checkValid=True):
    ...
    env = lmdb.open(outputPath, map_size=1024*1024*1200)
    cache = {}
    cnt = 1
...
if __name__ == '__main__':
    data_dir = '../datasets/mw_datasets/train'
    label_file_list = ['../datasets/mw_datasets/train.txt']
    save_path_root = '../datasets/mw_datasets_lmdb/'
